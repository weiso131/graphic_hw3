...
static SceneObject *generate_transformer(Shader *global_shader)
{
    ...
    SceneObject *main_body = new SceneObject(vertices, global_shader, main_body_model, glm::mat4(1.0f), main_body_motion, 36);
    ...
    SceneObject *head = new SceneObject(vertices, global_shader, head_model, head_tc, head_motion, 36);
    ...
    add_motion(waist_motion, 100, 0, 0, 0, 0, 0, 1.5f, 0.5f);
    add_motion_reverse(waist_motion, 100, 1, 0, 0, 0, 0, 1.5f, 0.5f);

    SceneObject *waist = new SceneObject(vertices, global_shader, waist_model, waist_tc, waist_motion, 36);   
    ...
    SceneObject *abdomen = new SceneObject(vertices, global_shader, abdomen_model, abdomen_ct, abdomen_motion, 36);
    ...
    SceneObject *left_arm1 = new SceneObject(vertices, global_shader, arm_model, left_arm1_tc, left_arm1_motion, 36);
    ...
    SceneObject *left_arm2 = new SceneObject(vertices, global_shader, arm_model, left_arm2_tc, left_arm2_motion, 36);
    ...
    SceneObject *right_arm1 = new SceneObject(vertices, global_shader, arm_model, right_arm1_tc, right_arm1_motion, 36);
    ...
    SceneObject *right_arm2 = new SceneObject(vertices, global_shader, arm_model, right_arm2_tc, right_arm2_motion, 36);
    ...
    SceneObject *left_leg1 = new SceneObject(vertices, global_shader, leg1_model, left_leg1_tc, leg1_motion, 36);
    ...
    SceneObject *left_leg2 = new SceneObject(vertices, global_shader, leg2_model, left_leg2_tc, left_leg2_motion, 36);
    left_leg1->add_child(left_leg2);

    //右腿
    //leg1
    glm::mat4 right_leg1_tc = glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, -1.0f, 0.0f));
    SceneObject *right_leg1 = new SceneObject(vertices, global_shader, leg1_model, right_leg1_tc, leg1_motion, 36);
    ...
    SceneObject *right_leg2 = new SceneObject(vertices, global_shader, leg2_model, right_leg2_tc, right_leg2_motion, 36);
